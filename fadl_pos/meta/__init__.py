...
BOOT_CUSTOMER_FIELDS = tuple(
    name for name, enabled in _CUSTOMER_FIELDS_MAP.items() if enabled
)
BOOT_POS_PROFILE_FIELDS = tuple(
    name for name, enabled in _POS_PROFILE_FIELDS_MAP.items() if enabled
)

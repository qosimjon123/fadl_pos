...
"""Customer credit redemption and phone payment-request helpers."""
...
from fadl_pos.utilities.processing.helpers import ensure_child_doctype
			...
			payment_entry_doc = frappe.get_doc(
				{
					...
					"reference_no": invoice_doc.pos_opening_entry,
